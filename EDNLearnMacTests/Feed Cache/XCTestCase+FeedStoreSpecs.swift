...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatSideEffectsRunSerially(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects to run serially but the operations finished in the wrong order", file: file, line: line)
    }
